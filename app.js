...
const I18N_DICT = {
  ...
  "Azzera quantita prodotti": {
    "en": "Reset product quantities",
    "fr": "Réinitialiser les quantités",
    "de": "Produktmengen zurücksetzen",
...
function __setTopbarCenterLabel__(){
  try{
    ...
    if (state && state.page === "calendario"){
      ...
      el.textContent = __capitalize__(monthNameIT(a));
